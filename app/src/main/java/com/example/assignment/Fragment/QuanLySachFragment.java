...
public class QuanLySachFragment extends Fragment {
    ...
    public void DiaLogThem(){
        ...
        TextInputEditText ed_cotsach = view.findViewById(R.id.ed_cot_sach);
        ...
        btn_them_sach.setOnClickListener (new View.OnClickListener () {
            @Override
            public void onClick(View v) {
                if (ed_cotsach.getText().toString().isEmpty()){
                    Toast.makeText(getActivity(),"Vui Lòng Nhập Cột Sách",Toast.LENGTH_SHORT).show();
                }else if(ed_masach.getText ().toString ().isEmpty ()){
                ...
                Sach sach = new Sach ();
                sach.setCotSach(Integer.parseInt(ed_cotsach.getText().toString()));
