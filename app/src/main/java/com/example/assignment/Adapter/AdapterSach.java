...
public class AdapterSach extends RecyclerView.Adapter<AdapterSach.SachViewHodel>{
    ...
    public void onBindViewHolder(@NonNull SachViewHodel holder, int position) {
        ...
        holder.tv_cot_sach.setText(sach.getCotSach()+"");
        if (sach.getCotSach()>1000){
            holder.tv_ma_Sach.setTextColor(ContextCompat.getColor(context,R.color.black));
            holder.tv_ten_sach.setTextColor(ContextCompat.getColor(context,R.color.black));
            holder.tv_gia_thue.setTextColor(ContextCompat.getColor(context,R.color.black));
            holder.tv_cot_sach.setTextColor(ContextCompat.getColor(context,R.color.black));
        }
    ...
    public class SachViewHodel extends RecyclerView.ViewHolder {
        TextView tv_ma_Sach , tv_ten_sach , tv_gia_thue , tv_cot_sach;
        ...
        public SachViewHodel(@NonNull View itemView) {
            ...
            tv_cot_sach = itemView.findViewById(R.id.tv_cot_sach);
