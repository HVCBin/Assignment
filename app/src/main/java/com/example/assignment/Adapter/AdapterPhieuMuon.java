...
//        holder.tv_ma_thanh_vien.setText ("Mã thành viên : " + pm.getMaTV ()+"");
        ...
        holder.click_update.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                TextInputEditText ed_sua_trangthai = view.findViewById(R.id.ed_sua_trangthai);
                    ...
                    public void onClick(View v) {
                        DatePickerDialog dialog = new DatePickerDialog (context, new DatePickerDialog.OnDateSetListener () {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                                month = month+1;
                                ed_ngay_thue.setText (dayOfMonth+"/" + month + "/" + year);
                            }
                ...
                builder.setPositiveButton ("Đồng ý", new DialogInterface.OnClickListener () {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        pm.setTraSach (ed_sua_trangthai.getText().toString() );
